/** Consistent page title block with optional mono eyebrow + action area. */
  ...
  return (
    <div className="reveal mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
      <div>
        ...
        <h1 className="font-display text-3xl font-extrabold tracking-tight text-fog-50 sm:text-4xl">{title}</h1>
